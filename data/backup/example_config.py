config = {
    ...
    "DEFAULT" : {
        ...
        "global_sig": "\n[center][url=https://github.com/precise4/uploadrr][img=400]https://i.ibb.co/2NVWb0c/uploadrr.webp[/img][/url][/center]", 
        "global_anon_sig": "\n[center][url=https://github.com/precise4/uploadrr][img=40]https://i.ibb.co/n0jF73x/hacker.png[/img][/url][/center]",
        "global_pr_sig": "\n[center][size=6][b]Personal Release[/b][/size][/center]\n[center][url=https://github.com/precicse4/uploadrr][img=400]https://i.ibb.co/2NVWb0c/uploadrr.webp[/img][/url][/center]", #personal realease signature
        "global_anon_pr_sig": "\n[center][url=https://github.com/precise4/uploadrr][img=40]https://i.ibb.co/n0jF73x/hacker.png[/img][/url][/center]",	 
    ...
    "TRACKERS" : {
        ...
        "LDU" : {
            ...
            "anon" : False,
            "signature" : "\n[center][b]PLEASE SEED LDU FAMILY[/b][/center]\n[center][url=https://github.com/precise4/uploadrr][img=400]https://i.ibb.co/2NVWb0c/uploadrr.webp[/img][/url][/center]", #Only used if "use_global_sigs" : False,
            "anon_signature" : "\n[center][url=https://github.com/precise4/Uploadrr][img=40]https://i.ibb.co/n0jF73x/hacker.png[/img][/url][/center]", #Only used if "use_global_sigs" : False, AND your uploading as "anon" : True, or passing -a at upload
            "pr_signature": "\n [center]PERSONAL RELEASE[/center] \n[center][b]PLEASE SEED LDU FAMILY[/b][/center]\n[center][url=https://github.com/precise4/uploadrr][img=400]https://i.ibb.co/2NVWb0c/uploadrr.webp[/img][/url][/center]", #Only used if "use_global_sigs" : False, AND -pr
            "anon_pr_signature": "\n[center][url=https://github.com/precise4/Uploadrr][img=40]https://i.ibb.co/n0jF73x/hacker.png[/img][/url][/center]", #Only used if "use_global_sigs" : False, AND your uploading as "anon" : True, or passing -a with -pr at upload
            },   
